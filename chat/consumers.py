...
class GroupConsumer(WebsocketConsumer):
    async def connect(self):
        ...
        # обычно в качестве канального слоя используется channel_redis,
        # но мы в качестве академического проекта будем использовать слои канала памяти,
        # которые предоставляет библиотека django-channels
